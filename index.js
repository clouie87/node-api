...
photoRouter.get('/', function(req, res){
    ...
    postgres.client.query(sql, function(err, result) {
        ...
        sql = 'SELECT photo.*, COUNT(votes.*) AS votecount, users.name as username FROM photo, users LEFT JOIN votes ON photo.u_id = users.u_id AND photo.id = votes.p_id GROUP BY photo.id, users.name OFFSET $1 LIMIT $2';
